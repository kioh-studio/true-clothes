...
// Phone: +84 000 000 000   Email: demo@mily.app   OTP: 000000
//
...
// (demo@mily.app) via password, so it has a STABLE uid that owns a pre-seeded
...
export const DEMO_EMAIL = 'demo@mily.app';
