SCREEN_SPEC:
  ...
  design_path: "app/design/screen/onboarding/body-measurement/"
  ...
  responsive_layout:
    - "Body must be scrollable: put content (header + inputs + determine section) in a scrollable column so it never overflows."
  ...
  notes:
    ...
    - "Progress indicator: highlight the 3rd step (body_measurement) in the onboarding progress bar (the center dot filled), matching the PNG/SVG."
