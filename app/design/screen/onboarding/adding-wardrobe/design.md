SCREEN_SPEC:
  ...
  design_path: "app/design/screen/onboarding/adding-wardrobe/"
  ...
  purpose:
    ...
    details:
      ...
      - "This final onboarding step focuses on collecting existing items first."
  ...
  layout:
    header:
      ...
      subtitle: "Let us know about your exisiting items and building outstanding outfits together"
      font:
        family: "Poppins"
        weight: "medium"
        size_px: 20
    ...
    body:
      ...
      sections:
        - id: wardrobe_drop_zone
          ...
          ui:
            dashed_upload_rect:
              description: "Large dashed rectangle placeholder (click/upload later)."
  ...
  notes:
    - "Refer to wardrobe.png for overall visual layout; use wardrobe.svg for precise sizes and spacing."
