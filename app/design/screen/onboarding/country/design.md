SCREEN_SPEC:
  ...
  design_path: "app/design/screen/onboarding/country/"
  ...
  responsive_layout:
    - "Body scrollable (weight(1f) + verticalScroll); footer (progress bar) fixed at bottom."
    - "Use scaled dimensions (app/design/responsive-ui.md)."

  notes:
    - "Use PNG/SVG in this folder for layout reference; implement responsively."
