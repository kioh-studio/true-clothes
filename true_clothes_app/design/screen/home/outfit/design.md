SCREEN_SPEC:
  ...
  design_path: "design/screen/home/outfit/"
        ...
        right:
          - action_link:
              ...
              positioning:
                ...
                padding_right_dp: 29
              touch_and_overflow:
                min_touch_target_height: 48
                min_touch_target_width: 48
                notes:
  ...
  responsive_layout:
    ...
    - "Verify narrowest target width (~320 logical px): tags wrap, item row does not force horizontal scroll; link column may shrink with ellipsis."
  ...
  ux_skill_reference:
    ...
    touch_and_interaction:
      - "Action links: minimum ~48x48 logical px touch target; ripple or opacity feedback on press."
