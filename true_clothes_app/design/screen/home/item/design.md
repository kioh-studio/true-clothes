SCREEN_SPEC:
  ...
  design_path: "design/screen/home/item/"
  reference_assets:
    - "item.svg"
  ...
  ux_skill_reference:
    ...
    accessibility:
      ...
      - "Hero image: meaningful photo → accessibility label summarizing the item; if purely decorative, mark decorative for screen readers."
    ...
    touch_and_interaction:
      - "Product link hit area: minimum ~48x48 logical px (Material) / ~44x44 pt (Apple HIG); extend touch target beyond underline if visual text is smaller."
    ...
    performance:
      ...
      - "Respect reduced-motion user preference: no non-essential banner motion, or substitute instant/crossfade."
    typography:
  ...
  notes:
    - "Cross-check `item.svg` for fine spacing and typography tweaks when implementing."
