SCREEN_SPEC:
  ...
  responsive_layout:
    - "Body must be scrollable: put form content (header + fields + gender) in a scrollable column with flexible height so it never overflows."
  ...
  notes:
    - "Refer to gender.svg in this folder for layout and spacing. Export a PNG from the design tool if you need a raster mock for reviews."
