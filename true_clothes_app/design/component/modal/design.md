COMPONENT_SPEC:
  id: component.modal
  design_path: "design/component/modal/"
  ...
  responsive_layout:
    - "Use scaled dimensions for padding, corner radius, and typography so the modal looks consistent across devices; see design/responsive-ui.md."

  notes:
    - "Refer to modal.svg in this folder for layout and spacing."
